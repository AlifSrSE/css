...
const Card = React.forwardRef((_a, ref) => {
    ...
    return (_jsx("div", Object.assign({ ref: ref, className: cn('rounded-lg border border-gray-200 bg-white shadow-sm', className) }, props)));
});
...
const CardTitle = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx("h3", Object.assign({ ref: ref, className: cn('text-lg font-semibold leading-none tracking-tight text-gray-900', className) }, props)));
});
CardTitle.displayName = 'CardTitle';
const CardDescription = React.forwardRef((_a, ref) => {
    var { className } = _a, props = __rest(_a, ["className"]);
    return (_jsx("p", Object.assign({ ref: ref, className: cn('text-sm text-gray-600', className) }, props)));
});
